...
from agent.tools.test_to_sql_tools import ListTablesTool, TableSchemaTool, SQLQueryTool, SQLQueryCheckerTool
...
tools = get_tools('127.0.0.1', 3306, 'root', '123456', 'test_db1')
...
if __name__ == '__main__':
    ...
    for step in agent.stream(
            input = {'messages': [{'role': 'user', 'content': '数据库中有多少学生，每个学生考了多少分？'}]},
            stream_mode="values"
    ):
