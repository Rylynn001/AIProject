...
if __name__ == '__main__':
    connection_string = "mysql+pymysql://root:123456@localhost:3306/test_db1?charset=utf8mb4"
    ...
    print(db_manager.execute_query("select * from scores"))
    print(db_manager.validate_query("SELECT ** from scores"))
